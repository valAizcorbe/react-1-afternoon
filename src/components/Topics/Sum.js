...
this.setState({ sum: num1 + num2})
    ...
    return (
        <div className = "puzzleBox sumPB">
            <h4>Sum</h4>
            <input className="inputLine" onChange = {(event) => this.updateNumber1(event.target.value)}></input>
            <input className="inputLine" onChange = {(event) => this.updateNumber2(event.target.value)}></input>
